...
#define SERVO_TC                (&AVR32_TC)
#define SERVO_TC_CHANNEL        1
#define SERVO_TC_IRQ            AVR32_TC_IRQ1
#define SERVO_TC_IRQ_GROUP      AVR32_TC_IRQ_GROUP
#define SERVO_TC_IRQ_PRIORITY   AVR32_INTC_INT0
#define SERVO_COMMAND_RATE_HZ   50
